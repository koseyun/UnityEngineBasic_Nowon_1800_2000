...
namespace Operators
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // conditional or
            // 앞쪽 피연산자가 true일 경우 뒤의 피연산자 연산하지 않고 바로 true 반환
            Console.WriteLine(A || B);

            // conditional and
            // 앞쪽 피연산자가 false일 경우 뒤의 피연산자 연산하지 않고 바로 false 반환
            Console.WriteLine(A && B);
            ...
            // or
            Console.WriteLine(a | b);     // ... -> 0 24개 생략 (. 하나당 8자리)
            // a == 14 == 2^3 + 2^2 + 2^1 == ...00001110
            // b == 6 ==        2^2 + 2^1 == ...00000110
            // or result                  == ...00001110 == 14

            // and
            Console.WriteLine(a & b);     // ... -> 0 24개 생략
            // a == 14 == 2^3 + 2^2 + 2^1 == ...00001110
            // b == 6 ==        2^2 + 2^1 == ...00000110
