...
public class Test : MonoBehaviour
{
    ...
    /// <summary>
    /// Script 를 GameObject 에 붙일때 처음 호출됨
    ...
    /// <summary>
    /// Editor 에서 Gizmo(에디터상의 그래픽적인 요소들) 들을 그릴 때 호출되는 ㅎ마수
    /// </summary>
    ...
    /// <summary>
    /// Script Instance 가 비활성화될 때마다 호출
    /// </summary>
