...
/// <summary>
/// Object Pooling :
/// 필요한 객체들을 Pool에 미리 생성해놓고 필요할때마다 가져다쓰고 파괴해야할 경우에는 파괴하지않고 비활성화해서 Pool에 반납
/// 이렇게 하는 이유는 객체가 파괴될대 가비지컬렉션이 일어나고, 가비지컬렉션은 프레임드롭을 유발할 수 있다
/// </summary>
public class ObjectPool : MonoBehaviour
{
    ...
    /// 해당 element 에 대한 대기열이 없으면 생성해서 대기열에 생성된 각 element 들을 등록해준다
    /// </summary>
